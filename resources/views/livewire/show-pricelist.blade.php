<div>
	...
	<div class="item__header">
		...
		<div class="item__header-buttons">
			...
			<a class="item__header-btn" href="{{ route("new_pricelist") }}" data-tooltip-center="Create a new Pricelist">
				<svg>
			...
			@if ($edititem === null)
				<button class="item__header-btn" type="button" value="Edit" wire:click.prevent="edititem()" data-tooltip-center="Edit this Pricelist">
					<svg>
			...
			@endif
			<button wire:click.prevent="confirmItemRemoval({{ $pricelist->id }})" class="item__header-btn delete" type="button" value="Delete" data-tooltip-right="Delete this Pricelist">
				<svg>
		...
		<div class="tab__list">
			<div class="tabs__content active" id="Details">
				<div class="item__form">
					...
					@if ($edititem != null)
						<button class="item__form-btn item__form-long" wire:click.prevent="saveitem()" type="button" value="Save">
							Save
						</button>
					@endif
				</div>
