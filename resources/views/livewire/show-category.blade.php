	...
	<div class="item__header">
		...
		<div class="item__header-buttons">
			...
			@if ($editcategory === null)
				<button class="item__header-btn" type="button" value="Edit" wire:click.prevent="editcategory()" data-tooltip-center="Edit this Category">
					<svg>
			...
			@else
				<button class="item__header-btn confirm" type="button" wire:click.prevent="savecategory()" value="Save" data-tooltip-center="Save this changes">
					<svg>
						<polyline points="20 6 9 17 4 12"></polyline>
					</svg>
				</button>
				<button class="item__header-btn" type="button" wire:click.prevent="cancelcategory()" value="Cancel" data-tooltip-center="Cancel this changes">
					<svg>
			...
			@endif
			<button wire:click.prevent="confirmItemRemoval({{ $category->id }})" class="item__header-btn delete" type="button" value="Delete" data-tooltip-right="Delete this Category">
				<svg>
