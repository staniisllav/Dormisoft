<div>
	...
	<div class="item__header">
		...
		<div class="item__header-buttons">
			...
			@if ($editproduct === null)
				<button class="item__header-btn" type="button" value="Edit" wire:click.prevent="editproduct()" data-tooltip-center="Edit this Product">
					<svg>
			...
			@else
				<button class="item__header-btn confirm" type="button" wire:click.prevent="saveproduct()" value="Save" data-tooltip-center="Save this changes"><svg>
						<polyline points="20 6 9 17 4 12"></polyline>
					</svg></button>
				<button class="item__header-btn" type="button" wire:click.prevent="cancelproduct()" value="Cancel" data-tooltip-center="Cancel this changes"><svg>
			...
			@endif
			<button wire:click.prevent="confirmProductRemoval({{ $product->id }})" class="item__header-btn delete" type="button" value="Delete" data-tooltip-right="Delete this Product">
				<svg>
