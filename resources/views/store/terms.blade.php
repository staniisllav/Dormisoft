...
<main>
	...
	<section class="section__header container">
		...
		<p class="section__text">
			Magazinul online <a href="{{ url("/") }}" target="_blank">dormisoft.ro</a> (”magazin online”, ”site”) este deținut și operat de Moldaso Line S.R.L.
  ...
  <section class="container contract__container">
    ...
    <div class="contract">
        ...
        <p class="contract__descr">
            Întreg continutul <a href="{{ url("/") }}" target="_blank">www.dormisoft.ro</a>, incluzand dar nelimitandu-se la
    ...
    <div class="contract">
        ...
        <p class="contract__descr">
            Comunicările comerciale ale dormisoft.ro sunt transmise de catre Moldaso Line S.R.L. sau prin intermediul
        ...
        <p class="contract__descr">
            Preturile bunurilor si serviciilor afisate in cadrul site-ului www.dormisoft.ro includ T.V.A. conform
